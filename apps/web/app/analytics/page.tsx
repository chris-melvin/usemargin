...
export default function AnalyticsPage() {
  ...
  const { snapshots, netWorth, getFilteredSnapshots } = useNetWorth();
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-6 md:px-6 md:py-8">
        {/* Header */}
        <header
          className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 animate-in fade-in slide-in-from-top-4 duration-500"
        >
        ...
        {/* Footer */}
        <footer className="mt-8 pt-6 border-t border-stone-200/60 animate-in fade-in duration-700" style={{ animationDelay: "600ms" }}>
